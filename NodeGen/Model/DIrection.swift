...
struct Direction {
    func addRoute(view:MKMapView, locationFrom:CLLocationCoordinate2D, locationTo:CLLocationCoordinate2D)
    {
        // 始点と終点のMKPlacemarkを生成
        let fromPlacemark = MKPlacemark(coordinate:locationFrom, addressDictionary:nil)
        let toPlacemark   = MKPlacemark(coordinate:locationTo, addressDictionary:nil)
